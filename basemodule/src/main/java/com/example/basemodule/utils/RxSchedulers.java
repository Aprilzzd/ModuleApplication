...
import com.example.basemodule.net.error.HttpResultFunction;
import com.example.basemodule.net.error.ServerResultFunction;
...
public class RxSchedulers {
    ...
    private static final ObservableTransformer schedulersTransformer = new ObservableTransformer() {
        ...
        public ObservableSource apply(Observable upstream) {
            return upstream.map(new ServerResultFunction())
